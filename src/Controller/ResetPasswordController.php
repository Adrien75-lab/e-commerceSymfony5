...
class ResetPasswordController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        if ($request->get('email')) {
            ...
            # code...
            if ($user) {
                // Etape 1 : enregistrer en base de donnée la demande de reset_password avec user,token,createdAt, 
                ...
                $this->addFlash('notice','Vous allez recevoir dans quelques secondes un mail pour recevoir la procédure pour réinitialiser votre mot de passe');
            } else {
